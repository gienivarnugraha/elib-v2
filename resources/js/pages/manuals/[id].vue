  ...
  <div class="flex mb-4">
    <ACard class="w-full">
      <div class="a-card-body a-card-spacer">
        <p class="a-title"> {{ store.record.type }} </p>
        <p class="a-subtitle"> {{ store.record.part_number }} </p>
        ...
        <template #after>
          <div class="flex justify-end px-2">
            <ABtn class="" icon="i-bx-plus">
              ...
              <AMenu persist="content" class="max-h-72 overflow-y-auto">
...
const fields = new Fields([
  ...
  {
    "component": "v-input",
    "attribute": "index_date",
    "placeholder": "Enter Index Date",
    "label": "Index Date",
    "icon": null,
    "value": null,
    "isRequired": true,
