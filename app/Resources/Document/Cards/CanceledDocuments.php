...
use App\Resources\Document\Criteria\CanceledDocuments as CriteriaCanceledDocuments;

class CanceledDocuments extends Progression
{
  /**
  ...
  {
    $repository = resolve(DocumentRepository::class)->pushCriteria(CriteriaCanceledDocuments::class);
